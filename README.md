...
2. Запускаем файл [async_requests.py](async_requests.py), 
создается таблица в базе данных и заполняется данными.
3. Посмотреть содержимое таблицы можно например через `pgAdmin 4`


![2024-07-09_22-46-02.png](media/2024-07-09_22-46-02.png)
